...
import com.swagLabs.utilities.BaseClass;
...
public class SwagLabs2InventoryPageTest extends BaseClass {
	...
	@Parameters("browser")
	@BeforeMethod()
	public void openInventoryPageSetup(String browser) throws InterruptedException {
	...
	public void clickOpenMenu_Clickable_OpenedAllOptions() throws InterruptedException {
		...
		SwagLabsHomepage SwagLabsHomepage = new SwagLabsHomepage(driver);
		ArrayList<String> actOpAll = SwagLabsHomepage.clickOnOpenMenuButton();

...
public class SwagLabs1LoginPageTest extends BaseClass {
	...
	@Parameters("browser")
	@BeforeMethod
	public void openLoginPageSetup(String browser) {
	...
	@Test(priority = 2)
	public void doLogin_1ValidId2InvalidPwd_FailedLoginAndVerifyErrorMSG()
	...
	@Test(priority = 3)
	public void doLogin_1InvalidId2validPwd_FailedLoginAndVerifyErrorMSG()
			throws EncryptedDocumentException, IOException {
	...
	@Test(priority = 4)
	public void doLogin_1InvalidId2InvalidPwd_FailedLoginAndVerifyErrorMSG()
			throws EncryptedDocumentException, IOException {
	...
	@Test(priority = 5)
	public void doLogin_1EmptyId2GivenPwd_FailedLoginAndVerifyWarningMSG()
			throws EncryptedDocumentException, IOException {
	...
	@Test(priority = 6)
	public void doLogin_1EmptyPwd2GivenId_FailedLoginAndVerifyWarningMSG()
			throws EncryptedDocumentException, IOException {
	...
	@Test(priority = 7)
	public void doLogin_1EmptyId2EmptyPwd_FailedLoginAndVerifyWarningMSG() {
		SwagLabsLoginPage swagLabsLoginPage = new SwagLabsLoginPage(driver);
	...
	@Test(priority = 8)
	public void doLogin_Clickable_CompletedLogin() throws EncryptedDocumentException, IOException {
	...
	@Test(priority = 9)
	public void doLogin_SwagLabsLogo_DisplayedLogoAndVerifyText() {
	...
	@Test(priority = 10)
	public void doLogin_ErrorBoxCancelButton_ClosedErrorOrWarningMSG()
	...
	@Test(priority = 11)
	public void doLogin_PlaceHolderText_Displayed() {
		SwagLabsLoginPage swagLabsLoginPage = new SwagLabsLoginPage(driver);
